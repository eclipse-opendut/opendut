...
# wait for netbird to be ready, see https://docs.netbird.io/api/resources/instance#get-instance-status
wait_for_url "$NETBIRD_MANAGEMENT_URL/api/instance" 600 5 || exit 1
