...
sudo /usr/sbin/append_hosts.sh "$OPENDUT_HOSTS"

if [ ! -e /opendut_dev/.bash_history ]; then
    touch /opendut_dev/.bash_history
    rm $HOME/.bash_history
    ln -s /opendut_dev/.bash_history $HOME/.bash_history
fi
