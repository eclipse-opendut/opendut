...
pub use tables::TableDisplayType;
pub use tables::multiple_selection_table::{MultipleSelectionTable, MultipleSelectionTableRow, MultipleSelectionTableCell, CollapsableInfo};
...
impl FontAwesomeIcon {
    ...
    pub fn as_class(&self) -> &'static str {
        match self {
            ...
            FontAwesomeIcon::Duplicate => "fa-solid fa-clone",
            ...
            FontAwesomeIcon::Play => "fa-solid fa-play",
