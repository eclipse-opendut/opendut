...
pub use viper_test_suite::SuiteTab;
...
impl TabIdentifier {
    ...
    const VIPER_TEST_SUITE_STR: &'static str = "viper_test_suite";
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            TabIdentifier::ViperTestSuite => TabIdentifier::VIPER_TEST_SUITE_STR,
...
impl TryFrom<&str> for TabIdentifier {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
            ...
            TabIdentifier::VIPER_TEST_SUITE_STR => Ok(TabIdentifier::ViperTestSuite),
